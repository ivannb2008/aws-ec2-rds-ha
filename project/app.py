...
db_config = {
    'host': os.getenv('DB_HOST', 'guestbook-db-instance.coif8o9srynb.us-east-1.rds.amazonaws.com'),
    'user': os.getenv('DB_USER', 'ivansigma'),
    'password': os.getenv('DB_PASSWORD', 'ivansigma'),
